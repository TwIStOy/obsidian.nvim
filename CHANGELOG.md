...
- Added option `notes.title_pattern` to customize the pattern to guess the title.
...
- Move `note_id_func` to `notes.id_func`.
- Move `note_frontmatter_func` to `notes.frontmatter_func`.
